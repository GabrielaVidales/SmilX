...
<div class="pub-card">
    ...
    <div class="pub-body">
        ...
        <div class="pub-meta">
            ...
            <a class="pub-doi" href="{p['url']}" target="_blank" rel="noopener">
                DOI: {p['doi']}
            </a>
        </div>
    </div>
...
.pub-card:hover {{
    border-color: #2e4a72;
    box-shadow: 0 4px 18px rgba(46,74,114,0.18);
}}
.pub-number {{
    font-size: 22px;
    font-weight: 800;
...
<div class="topbar">
    <div class="topbar-inner">
        ...
        <div class="topbar-links">
            <a href="/" target="_self">Home</a>
            <a href="/Publications" target="_self" class="active">Publications</a>
        </div>
...
st.markdown(
    '<div class="page-subtitle">Research papers from the SmilX team.</div>',
    unsafe_allow_html=True
)
...
st.divider()
st.markdown("""
<div style="max-width:980px; color:#ffffff;">
